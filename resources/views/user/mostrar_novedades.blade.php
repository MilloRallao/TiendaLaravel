            ...
            <div class="container">
                <div class="aa-catg-head-banner-content">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active"><a href="{{ route('mostrar_condicion', 2) }}">Novedades</a></li>
                    </ol>
                </div>
            </div>
        </div>
              ...
              <ul class="aa-product-catg">
                ...
                @foreach($novedades as $novedad)
                    ...
                    <li>
                      <figure>
                          ...
                          @endforelse
                            ...
                            <figcaption>
                                ...
                                <input id="product_id" type="hidden" value="{{ $novedad->id }}">
                            </figcaption>
                      </figure>                         
                      ...
                      <!-- product badge -->
                      <span class="aa-badge aa-sale" href="javascript:void(0)">NOVEDAD</span>
                    </li>
                  @endforeach
