...
@section('title', @($familia->familia))

@section('content')

  <!-------------------------------------------------------- START HEADER BANNER SECTION --------------------------------------------->
  <section id="aa-catg-head-banner">
        <img src="{{ $familia->ruta_imagen }}" alt="{{ $familia->familia }}">
            ...
            <div class="container">
                <div class="aa-catg-head-banner-content">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active"><a href="{{ route('mostrar_familia', $familia->id) }}">{{ $familia->familia }}</a></li>
                    </ol>
                </div>
            </div>
        </div>
